...
try {
  ...
  assert.ok(/1,000円|再確認中/.test(walkText), "walk event must show a verified price or a visible review warning");
  report.checks.push("event status and invalid-price suppression");
